...
export default function HomePage() {
  ...
  const demoItems = [
  { link: '#', text: 'Analytics', image: 'https://picsum.photos/600/400?random=1' },
  { link: '#', text: 'AI', image: 'https://picsum.photos/600/400?random=2' },
  { link: '#', text: 'Design', image: 'https://picsum.photos/600/400?random=3' },
  { link: '#', text: 'Case Studies', image: 'https://picsum.photos/600/400?random=4' }
];
